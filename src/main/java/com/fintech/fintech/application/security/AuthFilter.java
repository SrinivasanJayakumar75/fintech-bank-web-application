            ...
            throws ServletException, IOException {
                ...
                if(token !=null){
                    ...
                    try{
                        ...
                        BadCredentialsException authenticationException = new BadCredentialsException(e.getMessage());
                        customAuthenticationEntryPoint.commence(request, response, authenticationException);
                        return; 
                    }

                    UserDetails userDetails = customUserDataService.loadUserByUsername(email);
